...
with(electricity_new,{
                       ...
                       plot(Time,as.numeric(as.character(Voltage)),xlab = "datetime",ylab = "Voltage",type = "l")
                      ...
                      plot(Time,as.numeric(as.character(Global_reactive_power)),xlab = "datetime",ylab = "Global Reactive Power",type = "l")
                         })

#copying the plot t pdf
